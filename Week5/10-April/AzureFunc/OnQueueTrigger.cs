...
public class OnQueueTrigger
{
    private readonly ApplicationDbContext _dbContext;
    private readonly ILogger<OnQueueTrigger> _logger;

    public OnQueueTrigger(ILogger<OnQueueTrigger> logger, ApplicationDbContext dbContext)
    {
        _logger = logger;
        _dbContext = dbContext;
    }

    [Function(nameof(OnQueueTrigger))]
